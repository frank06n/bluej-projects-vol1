...
public class Level_OnlyEven implements Level {
    final int rounds, numbers, qualify;
    public Level_OnlyEven(int rounds,  int qualify, int numbers) {
        this.rounds = rounds;
        this.qualify = qualify;
        this.numbers = numbers;
    }
    public Level_OnlyEven() {
        this(15, 5, 100);
    }
    ...
    public boolean guessed_correct(int player_input, int cpu_random) {
        return ((player_input % 2) == 0) && ((cpu_random % 2) == 0);
    }
